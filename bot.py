...
WEBAPP_URL = "https://joyboss556699-byte.github.io/Niva-exchange-/"
...
def api_config():
    return jsonify({
        "app_name": "NIVA EXCHANGE 💦",
        "firebase_ready": db is not None,
        "webapp_url_configured": WEBAPP_URL.startswith("https://")
    })
...
def create_order():
    try:
        ...
        order_data = {
            ...
            "price_per_1000": float(data.get("price_per_1000", 0)),
