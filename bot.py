...
# ============================================================
BOT_TOKEN = os.getenv("BOT_TOKEN", "8632858021:AAEliYvSo0HvCMwsRFrkVP3hk_aTCvnK3OI")
...
FIREBASE_CREDENTIALS = {
    ...
    "project_id": os.getenv("FIREBASE_PROJECT_ID", "nivaeexchangebot"),
    "private_key_id": os.getenv("FIREBASE_PRIVATE_KEY_ID", "043156c2f0b1effd3fcc77a1654d5f734ec71f86"),
    "private_key": os.getenv(
        "FIREBASE_PRIVATE_KEY",
        "-----BEGIN PRIVATE KEY-----\n"
        "MIIEvgIBADANBgkqhkiG9w0BAQEFAASCBKgwggSkAgEAAoIBAQCiztTGGBBnmqEt\n"
        "l7AVcnSWYWdvtyQ2C3psYzHe7wc91jwCiP/8tq4+5HowNUAv5MWwtLfWW+FD8Ruf\n"
        "VPwtQ834p4d88QTynYxNLd4zAOj3YpyfuKDkGh2ZQqbYPQbVwt33a++gAPT3cCmq\n"
        "Q5+H+h7wNit9tL2hCD2KcuiO12xlGod4z9cvEMk5TMRKeNg5Dziwg9WflkO+0wqG\n"
        "L2pK+lCHAzNFJ7HB3EMtV0yYBhaTxH7ET/b/iL+JntNtUU+WrmpLKJ2AUH9lxK9Q\n"
        "8sBW5v2fvxtaB1xkT46Bt3Ot/3kcrB4qEcaQ+JqgsJCYkQfD/gZGD/S3lHOsGDF2\n"
        "TvjA0g2dAgMBAAECggEAByGtvtang05J8KQUHcBjfIHcRM++KZLjpDNNKDGKvOnx\n"
        "O4AyTGjZJZ6e/pUakG6CPV0RL3XbXn1Fgzt3B2mQsGtwOygYmiMOFgRkFxJbYhjC\n"
        "+RkejRdaxA+gHNlBfyQX0oJ7HuRj1qHmZVOsfYmWiNmqmolMBC2G+pVRfA5SLHSE\n"
        "5lcg2fRmlANpTBo7F6Z3mP49dtaqWn8L+UFkvT1ml/z9z+gO5b1xTDrmDaNT4ShZ\n"
        "URyPM1cCqot3lYa+0iEPVkE7heClQBOzE8XcDTYLEnQOnnlLe5nrwsXnb2hLTRjA\n"
        "41x830eblu4avY+J9MYe6enBvSLyimwezzGyp3BhgQKBgQDQqp2bxe6qpgFdwM3h\n"
        "ktc1Aoe2en3Z5ngs0loLh+W5MGTMt7fK51oEnISrjvIjVpnWyVNJEKGZEMadg6eq\n"
        "+EG9R0YGiHZI1uzbcp53SkSwThXO/w3NGBg+HI13IKU8uYRaPs9M2hAPIUVfyJUa\n"
        "39Y5duuWf8dRp0TeKUysbYJfgQKBgQDHvS77fKPjjIpaV4EUCwxoaBuxipwha51T\n"
        "nB/r01H1Z+lCPrT2lrSJMKboasH/Gb5gmV+Xcp5LI/XIc11SlrizaGEmN+6fc/Bb\n"
        "/z2VZj8ojojD3qwR/k7HidKZNJSPa1URVdAcDnr1ypOBR0aV+/sP1/o9z/CnR9lB\n"
        "1si/wCs8HQKBgQDP7yUNpIj3nmNAJLBEt8oitfm9GoUszWA18gvu76Y5C4N3CSBq\n"
        "Xm6yp7IBL3oVQugcRBTte1g9Kp1xO0+qrKb90fdy7StJ3Hq9F5PX9bdLJRTQaBM9\n"
        "rGQECPnjmzFtuMSuFWcIA0j7esEh+MS0uhdEvj93gq+Bq7iR1f/k11+SgQKBgQDD\n"
        "pukSpzDSgKQ1gmmJ/JiW3QPjkWcGxadCczhBhKpPvQ2cOliBA3asu9+C4rBM9iap\n"
        "8RLWAwxThlIHnBnaAJHEC4a+LSOtRaA4PXlRkupjC9ukIcZjibwZcUO9lue+5OBb\n"
        "LrfAA98mTNzYUb0uxblT97fEPJ/6/EIwX/gc/FxdcQKBgCba2yfNrIX5H0YReNFq\n"
        "9LmisKmmjtuLDKXn1aiFbp+bDEwfCokDBDHRTvwncd7ctSvcVaRZq2ou0wUSDuT2\n"
        "YEh1S7O2U2Xs0bGDlcVXTrJEv4iNTCadvLe9/t+U4g/M8ifMc7Tl9G76j5PR3pSJ\n"
        "CesWHoiZR5a2UM9d3zcA/k54\n"
        "-----END PRIVATE KEY-----\n"
    ),
    "client_email": os.getenv(
        "FIREBASE_CLIENT_EMAIL",
        "firebase-adminsdk-fbsvc@nivaeexchangebot.iam.gserviceaccount.com",
    ),
    "client_id": os.getenv("FIREBASE_CLIENT_ID", "112064012645757464936"),
    ...
    "client_x509_cert_url": os.getenv(
        ...
        "firebase-adminsdk-fbsvc%40nivaeexchangebot.iam.gserviceaccount.com",
    ),
