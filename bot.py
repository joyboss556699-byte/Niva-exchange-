...
def get_config():
    ...
    try:
        ...
        return jsonify({"ok": True, "coins": normalized_coins, "paymentMethods": payment_methods, "branding": branding, "binanceRate": binance_rate, "transferId": transfer_id, "transferUsername": transfer_username, "transferProfileImage": transfer_profile_image, "sendFee": 0})
    except Exception as e:
        return jsonify({"ok": False, "error": str(e)}), 500
