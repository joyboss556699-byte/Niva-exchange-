...
<body>
    ...
    <script>
        ...
        function renderTransferProfilePreview(url){
            ...
            if(!box)return;
            box.innerHTML=url ? `<img src="${escapeAttr(panelAssetUrl(url))}" style="width:70px;height:70px;border-radius:50%;object-fit:cover;border:2px solid #31b8f4">` : '<span class="small-note">No profile picture</span>';
        }
